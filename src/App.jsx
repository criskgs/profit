...
const TABS=[{key:'profit',label:'Profit camion'},{key:'fuel',label:'Motorină necesară'},{key:'breaks',label:'Pauze șofer'}];
...
export default function App(){
  ...
  function exportPDF(){
    ...
    const opt={margin:[10,10,10,10], filename:`raport-${tab}.pdf`, image:{type:'jpeg',quality:0.98},
      ...
      jsPDF:{unit:'mm',format:'a4',orientation: tab==='profit'?'landscape':'portrait'},
  ...
  return (<div className='min-h-screen bg-[color:var(--brand-dark)] text-white'>
    <div className='bg-black border-b border-[#2d2d2d] sticky top-0 z-10 no-print'>
      ...
      <div className='max-w-6xl mx-auto px-6 pb-3 flex gap-2'>
